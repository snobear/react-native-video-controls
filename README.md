...
We forked this in order to have more control over how video controls look and move off screen. Previouslyt the controls would animate off screen 100px which causes other video comment boxes and rating stars to be covered up by an invisible layer, and thus the user couldn't tap anything.
